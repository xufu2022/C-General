...
using _05_XPath.EntityClasses;
using _05_XPath.HelperClasses;

namespace _05_XPath.ViewModels
{
  /// <summary>
  ...
  public class ElementViewModel
  {
    ...
    public XElement GetLastNode()
    {
      ...
      // TODO: Write Query Here
      prod = elem.XPathSelectElement("/Product[last()]");
    ...
    public List<XElement> GetFirstThreeNodes()
    {
      ...
      list = elem.XPathSelectElements("/Product[position()<=3]").ToList();
    ...
    public List<Product> AddToClass()
    {
      ...
      List<Product> list = new();
            ...
            // TODO: Write Query Here
            var query = elem.XPathSelectElements("/Product[Color='Silver']");
